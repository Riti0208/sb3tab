...
static const char *JP[STR_COUNT] = {
    ...
    [STR_GAMES_HINT]        = "A: あそぶ  X: けす  B: 戻る",
    ...
    [STR_LANGUAGE]          = "ことば",
    [STR_NETWORK]           = "Wi-Fi",
    [STR_WIFI_SAVED_FMT]    = "%s に接続中",
    [STR_WIFI_NONE]         = "Wi-Fi はまだだよ",
    [STR_WIFI_SCAN_QR]      = "QRを読みとる",
    [STR_SETTINGS_HINT]     = "上下で移動  左右で調整  A: 決定  B: 戻る",

    [STR_YES]               = "はい",
    [STR_NO]                = "いいえ",
    [STR_CONFIRM]           = "確認",
    [STR_DELETE_FMT]        = "「%s」を けしていい？",
    [STR_RETURN_TO_MENU]    = "メニューに戻る？",

    [STR_WIFI_CONNECTING]   = "Wi-Fi に接続中...",
    [STR_WIFI_CONNECTED]    = "接続できたよ！",
    [STR_WIFI_FAILED]       = "接続できなかった",
    [STR_DOWNLOADING]       = "ダウンロード中...",
    [STR_DL_COMPLETE]       = "ダウンロードできたよ！",
    [STR_DL_FAILED]         = "ダウンロードできなかった",
    [STR_LOADING]           = "読み込み中...",
    [STR_LOAD_FAILED]       = "読み込みできなかった",
    [STR_STARTING]          = "はじめるよ！",
    [STR_NO_WIFI]           = "Wi-Fi がつながってないよ",
    [STR_NO_WIFI_DETAIL]    = "設定から Wi-Fi をつないでね",
    [STR_BUTTON_MAP]        = "ボタンの使いかた",
    [STR_BUTTON_MAP_DETAIL] = "十字キー: 矢印  A: スペース",
    [STR_BUTTON_MAP_HINT]   = "B: とじる",
    [STR_BUTTON_MAP_NONE]   = "このゲームはボタンを使わないよ",
