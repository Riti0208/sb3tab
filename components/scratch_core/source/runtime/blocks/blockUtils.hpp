...
#define SCRATCH_BLOCK(category, id)                                                                                                    \
    ...
    static volatile uint8_t block_##category##_##id##_reg_ = (BlockExecutor::getHandlers()[#category "_" #id] = block_##category##_##id##_, 0); \
    BlockResult block_##category##_##id##_(Block &block, Sprite *sprite, bool *withoutScreenRefresh, bool fromRepeat)
...
#define SCRATCH_BLOCK_NOP(category, id) \
    static volatile uint8_t block_##category##_##id##_reg_ = (BlockExecutor::getHandlers()[#category "_" #id] = nopBlock, 0);
...
#define SCRATCH_REPORTER_BLOCK(category, id)                                                                                                \
    ...
    static volatile uint8_t block_##category##_##id##_reg_ = (BlockExecutor::getValueHandlers()[#category "_" #id] = block_##category##_##id##_, 0); \
    Value block_##category##_##id##_(Block &block, Sprite *sprite)
...
#define SCRATCH_REPORTER_BLOCK_OPCODE(opcode)                                                                   \
    ...
    static volatile uint8_t block_##opcode##_reg_ = (BlockExecutor::getValueHandlers()[#opcode] = block_##opcode##_, 0); \
    Value block_##opcode##_(Block &block, Sprite *sprite)
